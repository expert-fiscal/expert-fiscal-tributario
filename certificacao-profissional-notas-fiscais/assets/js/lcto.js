...
const lcto = {
  ...
  ,tit_roma: "<span style='color: #A9F62A;'>Domine </span> a aplicação prática da <br/> Nota Técnica <span style='color: #A9F62A;'>2025.002-RTC</span>"
  ,tit_cpl1: "Domine a aplicação prática da Nota Técnica 2025.002-RTC e aprenda a preencher corretamente os novos campos de IBS, CBS e IS nas Notas Fiscais eletrônicas conforme a LC 214/2025."
...
// Dia 27 de Novembro
dt_ev ? dt_ev.innerHTML = 'Dia ' + lcto.dt_cpl1.split('/')[0] + ' de ' + month_name[parseInt(lcto.dt_cpl3.split('/')[1])] + " de 2025": "" ;
